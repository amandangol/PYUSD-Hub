    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'Stay informed with real-time market data and MEV analytics',
            style: theme.textTheme.bodyLarge?.copyWith(
              color: theme.colorScheme.onSurface.withOpacity(0.7),
            ),
            textAlign: TextAlign.center,
          ...
          _buildFeatureItem(
            ...
            Icons.show_chart,
            'Market Analytics',
            'Real-time PYUSD price and trading data',
          ),
          const SizedBox(height: 16),
          _buildFeatureItem(
            theme,
            Icons.security,
            'MEV Risk Analysis',
            'Monitor and assess MEV risks in real-time',
          ),
          const SizedBox(height: 16),
          _buildFeatureItem(
            theme,
          ...
          _buildFeatureItem(
            ...
            'Identify potential MEV opportunities safely',
          ),
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'Monitor, analyze, and protect against MEV activities',
            style: theme.textTheme.bodyLarge?.copyWith(
              color: theme.colorScheme.onSurface.withOpacity(0.7),
            ),
            textAlign: TextAlign.center,
          ...
          _buildFeatureItem(
            ...
            Icons.warning_amber,
            'MEV Protection',
            'Detect and analyze sandwich attacks and frontrunning',
          ),
          const SizedBox(height: 16),
          _buildFeatureItem(
            theme,
            ...
            'Deep insights into transaction traces and MEV impact',
          ),
          const SizedBox(height: 16),
          _buildFeatureItem(
            theme,
            Icons.speed,
            'Network Monitoring',
            'Track gas prices and MEV opportunities in real-time',
          ),
          const SizedBox(height: 16),
          _buildFeatureItem(
            theme,
            ...
            'Track and analyze past MEV activities',
          ),
        ],
      ),
    );
